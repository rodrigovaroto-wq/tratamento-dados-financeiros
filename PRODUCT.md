...
governado e prontidão de dados* (`docs/00_VISAO_E_ESCOPO.md`).
...
- **Doutrina de Autonomia** (`docs/01`): cada estágio do workflow nasce no seu
...
- `docs/00_VISAO_E_ESCOPO.md`, `docs/01_DOUTRINA_DE_AUTONOMIA.md`,
  `docs/06_HUMAN_IN_THE_LOOP.md`, `f0/07_output_spec.md` — a doutrina do
  produto.
