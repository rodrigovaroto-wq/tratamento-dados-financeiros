...
`Dados de Teste/book-vertentes` — é o cenário em que o dono diz "o arquivo foi 100%
...
Uso (de dentro de Dados de Teste/book-vertentes, que é onde os módulos do book vivem):

    cd "Dados de Teste"/book-vertentes
    python3 ../../Supabase/test/gerar_fixture.py > ../../Supabase/test/fixture_book_vertentes.sql
...
# ----------------------------------------------------------------------- emitir
out = [
    "-- GERADO por Supabase/test/gerar_fixture.py — não editar à mão.",
    "-- Extração FIEL dos 14 documentos de Dados de Teste/book-vertentes.",
        ...
        "campos": [
            {
                ...
                # `ordem` = posição da linha NO DOCUMENTO (Supabase/migrations/0027). É o
