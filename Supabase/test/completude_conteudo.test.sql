-- Testes de "documento que chegou vazio não cumpre item" (Supabase/migrations/0036).
...
begin
  ...
  -- Arquitetura do Sistema/3 Estado e Execução/07: "elegível ao Portão 2 se e somente se não há pendência bloqueante
  ...
  perform teste_assert_cc(v_n > 0,
    'o caso tem bloqueante aberta, logo NÃO é elegível ao Portão 2 (Arquitetura do Sistema/3 Estado e Execução/07)');
