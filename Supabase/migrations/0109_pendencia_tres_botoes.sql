...
--     responder POR QUÊ.
--   • DATA DE EXPIRAÇÃO da ressalva (0107, exigida por Arquitetura do Sistema/2 Especificação/f0/04): sai. A ressalva
--     passa a valer para sempre — não há mais o vencimento que a fazia voltar a
--     bloquear sozinha.
--   • TETO DE 3 RESSALVAS (Arquitetura do Sistema/2 Especificação/f0/04, confirmado pelo dono em 2026-07-14): sai. Era
...
--
--   • E A LISTA FECHADA de Arquitetura do Sistema/2 Especificação/f0/04 (a "não-sobrepujável", que nenhuma ressalva
...
-- o que `Arquitetura do Sistema/2 Especificação/f0/04` chama de não resolvida. Os três estados finais — resolvida,
...
comment on function fn_avaliar_portao2(uuid) is
  ...
  'a lista fechada de Arquitetura do Sistema/2 Especificação/f0/04 deixaram de bloquear por decisão do dono — as contagens continuam '
