...
--
-- Doutrina (Arquitetura do Sistema/2 Especificação/04_RECONCILIACAO.md): Classe B = semi-objetiva (agregação/
...
--
-- Mesma disciplina de pré-condição da Classe A (Arquitetura do Sistema/1 Visão e Doutrina/02): faltou documento,
