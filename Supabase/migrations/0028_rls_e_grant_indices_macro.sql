...
--
-- POR QUE ISSO NÃO FOI PEGO POR TESTE NENHUM: `Supabase/test/run.sh` roda tudo como
...
-- `Supabase/test/run.sh` reproduz o default de projeto que o Supabase provê (GRANT
