...
-- Export Excel (E4, primeira fatia — Arquitetura do Sistema/2 Especificação/f0/07_output_spec.md)
--
-- Princípio inegociável (Arquitetura do Sistema/2 Especificação/f0/07): "Nenhum número entra na base viva ou no
...
--
-- Granularidade v0 (Arquitetura do Sistema/2 Especificação/f0/07 permite refinar o "layout fino" depois): aceite é
...
comment on column campo_extraido.status_aceite is
  'Portão 2 (E4, Arquitetura do Sistema/2 Especificação/f0/07): pendente = sugestão N0/N1, não é fato; aceito = decisao humana ligada, entra no export como fato; com_ressalva = aceito com ressalva.';
