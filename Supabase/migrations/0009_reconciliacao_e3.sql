...
--
-- Doutrina (Arquitetura do Sistema/2 Especificação/04_RECONCILIACAO.md): Classe A = identidades aritméticas puras,
...
-- Pré-condição não satisfeita → pendência tipada, nunca um "OK" falso (Arquitetura do Sistema/1 Visão e Doutrina/02).
--
-- Duas checagens (os dois exemplos canônicos de Arquitetura do Sistema/2 Especificação/04):
...
-- (Arquitetura do Sistema/2 Especificação/04: "papel do LLM só como hipótese explicativa depois de detectado
...
-- é o log append-only de cada execução (Arquitetura do Sistema/2 Especificação/f0/05).
-- -----------------------------------------------------------------------------
...
-- período. Pré-condição extra (Arquitetura do Sistema/2 Especificação/04: "mesma moeda"): se as duas linhas
...
-- burro/stateless (Arquitetura do Sistema/1 Visão e Doutrina/02).
-- -----------------------------------------------------------------------------
