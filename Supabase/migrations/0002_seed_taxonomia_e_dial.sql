-- =============================================================================
-- Migration 0002 — Seed da taxonomia (Arquitetura do Sistema/2 Especificação/f0/03) + dial de autonomia inicial (Arquitetura do Sistema/2 Especificação/f0/04)
...
-- -----------------------------------------------------------------------------
-- Dial de autonomia inicial da F1 (Arquitetura do Sistema/2 Especificação/f0/04 — estado inicial + teto)
