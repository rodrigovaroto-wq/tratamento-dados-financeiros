...
--
-- Solução (doutrina Arquitetura do Sistema/1 Visão e Doutrina/01, N1 — sugestão, nunca fato): a MESMA chamada de
...
-- auto-clear), é preciso golden set + concordância medida (Arquitetura do Sistema/1 Visão e Doutrina/01 regra de
-- ouro, Arquitetura do Sistema/2 Especificação/f0/06) — não é o que esta migration faz.
-- =============================================================================
