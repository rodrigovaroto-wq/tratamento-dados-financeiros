...
-- `Arquitetura do Sistema/1 Visão e Doutrina/01` dentro de `fn_mudar_dial`: estágio interpretativo só sobe para N2/N3
...
-- tipo já preenchido e decide se muda; o rotulador cego do `Arquitetura do Sistema/2 Especificação/f0/06` decide sem
...
-- pelo `Arquitetura do Sistema/2 Especificação/f0/06` para rótulo cego. Rótulo enviesado exige mais massa para dizer a
...
comment on column golden_criterio.n_minimo_veredito is
  ...
  'Maior que n_minimo (20, do Arquitetura do Sistema/2 Especificação/f0/06) de propósito: o veredito de produção vê o palpite da máquina, '
...
-- 0126: o dial é por estágio, o `Arquitetura do Sistema/2 Especificação/f0/06` raciocina por tipo, e autonomia por
