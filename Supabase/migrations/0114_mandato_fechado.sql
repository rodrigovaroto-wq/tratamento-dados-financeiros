...
-- (Arquitetura do Sistema/2 Especificação/f0/04) descreve onde o mandato está no TRABALHO — intake, em triagem, em
...
comment on column caso.fechado_em is
  'Quando o mandato saiu da mesa. NULL = ativo. Não é status de trabalho (esse é `status`, Arquitetura do Sistema/2 Especificação/f0/04): '
