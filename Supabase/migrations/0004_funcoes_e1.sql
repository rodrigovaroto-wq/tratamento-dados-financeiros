...
-- que o N8N fique STATELESS e chame uma função por passo (Arquitetura do Sistema/1 Visão e Doutrina/02, trava nº 1).
...
-- Marca de bloqueante não-sobrepujável na taxonomia (Arquitetura do Sistema/2 Especificação/f0/04, lista fechada).
