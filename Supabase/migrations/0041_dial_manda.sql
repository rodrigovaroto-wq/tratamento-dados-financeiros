...
-- golden-set que Arquitetura do Sistema/1 Visão e Doutrina/01 normalmente exige") — mas o dial no banco nunca foi
...
-- que Arquitetura do Sistema/1 Visão e Doutrina/01 diga que "toda subida de nível é uma decisão versionada e
...
-- registrada. É o que torna real o "versionada e reversível" de Arquitetura do Sistema/1 Visão e Doutrina/01.
--
...
begin
  ...
  -- (Arquitetura do Sistema/1 Visão e Doutrina/01, Arquitetura do Sistema/2 Especificação/f0/06): nenhum número sugerido por IA vira fato sem aceite. Uma
...
-- N2 é decisão de produto do dono, NÃO autonomia medida. `Arquitetura do Sistema/1 Visão e Doutrina/01` exige
...
begin
  v_r := fn_mudar_dial('extracao_linhas_financeiras', 'N2', 'sistema:0041',
    ...
    'set físico não existe ainda, e Arquitetura do Sistema/1 Visão e Doutrina/01 exige concordância medida para subir dial de estágio '
    'interpretativo.', 0.95);
