...
-- Materializa o subconjunto de Arquitetura do Sistema/2 Especificação/f0/05_schema_conceitual.md necessário para o E1.
-- As tabelas de extração/reconciliação entram nas fatias que as usam.
--
-- Fonte da verdade do estado = Postgres (ver Arquitetura do Sistema/1 Visão e Doutrina/02, trava de stack nº 1).
...
-- -----------------------------------------------------------------------------
-- Tipos enumerados (máquinas de estado de Arquitetura do Sistema/2 Especificação/f0/04)
-- -----------------------------------------------------------------------------

-- Estado do CASO (Arquitetura do Sistema/2 Especificação/f0/04 — máquina de estado do caso)
...
-- Estado do DOCUMENTO/ITEM (Arquitetura do Sistema/2 Especificação/f0/04 — completude != validade)
...
-- Obrigatoriedade da taxonomia (Arquitetura do Sistema/2 Especificação/f0/03 — dois níveis)
create type obrigatoriedade as enum (
  'obrigatorio',   -- Kit Básico
  'complementar'   -- Variáveis
);

-- Sensibilidade LGPD (Arquitetura do Sistema/2 Especificação/f0/03 / Arquitetura do Sistema/2 Especificação/f0/05)
...
-- Granularidade do tipo de documento (Arquitetura do Sistema/2 Especificação/f0/03)
...
-- Catálogo de pendências (Arquitetura do Sistema/2 Especificação/f0/04)
...
-- Nível de autonomia por estágio (Doutrina de Autonomia, Arquitetura do Sistema/1 Visão e Doutrina/01)
create type nivel_autonomia as enum ('N0', 'N1', 'N2', 'N3');

-- Tipo de decisão humana (Arquitetura do Sistema/2 Especificação/f0/05)
...
-- -----------------------------------------------------------------------------
-- Taxonomia (fonte da verdade; versionada) — Arquitetura do Sistema/2 Especificação/f0/03
-- -----------------------------------------------------------------------------
...
comment on table taxonomia_tipo_documento is
  'Taxonomia documental v1 (Arquitetura do Sistema/2 Especificação/f0/03). Kit Básico = obrigatorio; Variáveis = complementar.';

-- -----------------------------------------------------------------------------
-- Caso / Entidade / Período (unidade de trabalho e eixos) — Arquitetura do Sistema/2 Especificação/f0/05
-- -----------------------------------------------------------------------------
create table caso (
...
-- -----------------------------------------------------------------------------
-- Documento + versões — Arquitetura do Sistema/2 Especificação/f0/05 (storage em dois modos, decisão 0.2)
-- -----------------------------------------------------------------------------
...
create table documento_versao (
  ...
  assinado        boolean,                -- flag (Assinado) da taxonomia (Arquitetura do Sistema/2 Especificação/f0/03)
...
-- -----------------------------------------------------------------------------
-- Checklist de completude (derivado da taxonomia × entidade × período) — Arquitetura do Sistema/2 Especificação/f0/04/05
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Motor de pendências — Arquitetura do Sistema/2 Especificação/f0/04
-- -----------------------------------------------------------------------------
create table pendencia (
  ...
  entidade_id     uuid references entidade(id),
  periodo_id      uuid references periodo(id),
  sobrepujavel    boolean not null default true,   -- false = bloqueante não-sobrepujável (Arquitetura do Sistema/2 Especificação/f0/04)
...
-- -----------------------------------------------------------------------------
-- Decisões humanas (append-only por convenção) — Arquitetura do Sistema/2 Especificação/f0/05
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Trilha de auditoria (append-only, imutável) — Arquitetura do Sistema/2 Especificação/f0/05, Arquitetura do Sistema/1 Visão e Doutrina/01 fechamento 7
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Dial de autonomia por estágio (config) — Arquitetura do Sistema/1 Visão e Doutrina/01, Arquitetura do Sistema/2 Especificação/f0/04
-- -----------------------------------------------------------------------------
...
comment on table estagio_autonomia is
  'O "dial" de autonomia por estágio. Nível é estado do sistema, não constante de código (Arquitetura do Sistema/1 Visão e Doutrina/01).';
