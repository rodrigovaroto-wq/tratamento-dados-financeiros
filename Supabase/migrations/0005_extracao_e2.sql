...
--
-- Adiciona a tabela campo_extraido (Arquitetura do Sistema/2 Especificação/f0/05) e as funções que a alimentam.
-- Doutrina (Arquitetura do Sistema/1 Visão e Doutrina/01, Arquitetura do Sistema/2 Especificação/f0/04): extração de linhas financeiras NASCE em N0 (sombra)
...
-- -----------------------------------------------------------------------------
-- Tabela de campos extraídos (com proveniência e confiança) — Arquitetura do Sistema/2 Especificação/f0/05, Arquitetura do Sistema/2 Especificação/f0/07
-- -----------------------------------------------------------------------------
