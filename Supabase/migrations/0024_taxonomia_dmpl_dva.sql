-- =============================================================================
-- Migration 0024 — DMPL e DVA na taxonomia (Arquitetura do Sistema/2 Especificação/f0/03)
--
...
-- de 8 obrigatórios travada em Arquitetura do Sistema/2 Especificação/f0/03, e mexer nela mudaria a completude
