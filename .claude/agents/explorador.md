...
- O nome de uma migration conta o defeito que ela corrige — `ls db/migrations/` é um índice
  legível, use antes de `grep`.
- `ESTADO.md` (topo) tem a rodada mais recente; `docs/MAPA_DE_EXECUCAO.md` tem o que falta;
