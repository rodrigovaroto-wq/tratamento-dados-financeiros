...
- **Fatia 1.7** — em construção em outra sessão em paralelo. Migrations `0182–0184` reservadas àquela sessão. *(→ escrita, medida e revisada: ver o bloco F1.7 acima.)*
...
- **Fatia 1.7:** modelar controle comum por pessoa física (grupo horizontal, sem holding). *(→ ver o bloco F1.7 acima.)*
