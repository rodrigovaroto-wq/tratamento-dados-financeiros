...
test('DMPL/DVA: enum de seção canônica, códigos do diagnóstico e contrato da matriz (Supabase/migrations/0024)', () => {
...
test('ORDEM da linha vem da posição no array, não do modelo (Supabase/migrations/0027)', () => {
