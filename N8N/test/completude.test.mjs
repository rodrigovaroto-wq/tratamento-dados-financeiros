...
test('bloqueantes não-sobrepujáveis marcados corretamente', () => {
  ...
  // Não-sobrepujáveis (Arquitetura do Sistema/2 Especificação/f0/04): DRE, BALANCO, COMBINADO, MUTUOS, CONTRATO_SOCIAL
...
// vazio. O terceiro estado usa o vocabulário de Arquitetura do Sistema/3 Estado e Execução/07 (`recebido_não_válido`)
...
test('…e a pendência é BLOQUEANTE e não-sobrepujável, sempre', () => {
  // Arquitetura do Sistema/3 Estado e Execução/07 põe "arquivo ilegível de item essencial" na lista fechada que
