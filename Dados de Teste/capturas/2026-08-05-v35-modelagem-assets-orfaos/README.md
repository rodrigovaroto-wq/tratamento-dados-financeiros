...
— ver `Dados de Teste/capturas/2026-08-04-v35-modelagem/`.
...
(conferido com `grep -rn "js.download"` fora de `Dados de Teste/capturas/`).
...
`Supabase/test/fixture_modelagem_v35.sql`.
