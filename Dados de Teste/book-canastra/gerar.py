...
"""Ponto de entrada do book CANASTRA: gera os PDFs, o gabarito e o guia.
    ...
    cd "Dados de Teste"/book-canastra && PYTHONPATH=. python3 gerar.py
...
# Arquitetura do Sistema/2 Especificação/f0/03 (`12M25`, `2025x2024`, `36 meses`), que o classificador resolve pelo
...
| Nomes de arquivo | todos na notação de Arquitetura do Sistema/2 Especificação/f0/03 | **metade como o cliente manda de verdade** |
