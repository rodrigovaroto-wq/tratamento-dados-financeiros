...
const campos=Array.isArray(p.linhas)?p.linhas.map(l=>({secao:l.secao??null, secao_canonica:(l.secao_canonica&&l.secao_canonica!=='NAO_CLASSIFICAVEL')?l.secao_canonica:null, chave:l.chave, valor_texto:l.valor_texto??null, valor_num:(typeof l.valor_num==='number')?l.valor_num:null, unidade, confianca:(typeof l.confianca==='number')?l.confianca:null, origem_pagina:Number.isInteger(l.origem_pagina)?l.origem_pagina:null})):[];
