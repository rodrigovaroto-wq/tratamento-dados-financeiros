...
O `docs/00` define o produto em uma frase, e ela é o critério contra o qual tudo abaixo é medido:
...
> `docs/MAPA_DE_EXECUCAO.md` (B3). A recomendação registrada: medir por **veredito de produção**
