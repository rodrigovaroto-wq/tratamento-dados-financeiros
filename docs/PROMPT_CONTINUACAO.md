...
> [`docs/prompts/00-continuacao.md`](prompts/00-continuacao.md).**
...
| O roteiro de abertura de sessão | `docs/prompts/00-continuacao.md` |
| A lista do que executar | `docs/MAPA_DE_EXECUCAO.md` — que tem dono e critério de pronto |
