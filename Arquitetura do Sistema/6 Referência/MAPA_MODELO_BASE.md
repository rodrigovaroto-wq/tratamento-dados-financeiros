# Mapa do Modelo Base — `Arquitetura do Sistema/6 Referência/modelo-base.xlsx`

Fase 1 de `Arquitetura do Sistema/5 Prompts/PROMPT_ESPELHAR_MODELO_BASE.md`: **mapear antes de replicar**. Este documento
...
python3 "Arquitetura do Sistema/6 Referência/mapear-xlsx.py" Arquitetura do Sistema/6 Referência/modelo-base.xlsx --aba "Balance Sheet" --celulas
```
...
```
===== Arquitetura do Sistema/6 Referência/modelo-base.xlsx — 0.5 MB =====
