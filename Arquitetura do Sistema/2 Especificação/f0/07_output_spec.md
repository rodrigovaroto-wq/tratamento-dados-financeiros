...
> — `Arquitetura do Sistema/1 Visão e Doutrina/00_VISAO_E_ESCOPO.md`
...
(ver `Arquitetura do Sistema/2 Especificação/05_CLASSIFICACAO_CONTABIL.md` e 0.5). **O output é consequência do Portão 2**, não
...
>
> **O que o §2.4 do `Arquitetura do Sistema/4 Análises e Auditorias/DIAGNOSTICO_SISTEMA_2026-08-11.md` cobrava eram duas saídas — construir o
...
> `Arquitetura do Sistema/2 Especificação/f0/08_padrao_entrega_analitica.md`.
...
2. **É mais fiel ao princípio de anti-ancoragem** (`Arquitetura do Sistema/1 Visão e Doutrina/01`): o número autoritativo é o que o
