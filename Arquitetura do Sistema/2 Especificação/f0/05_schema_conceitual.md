...
| `reconciliacao` | id, caso_id, tipo, classe (A/B/C), fonte_a, fonte_b, precondicoes_ok, resultado, divergencia, materialidade | Ver `Arquitetura do Sistema/2 Especificação/04_RECONCILIACAO.md` |
...
| `taxonomia_contabil` | codigo, rótulo, versao | Enum fechado (`Arquitetura do Sistema/2 Especificação/05_...`) |
