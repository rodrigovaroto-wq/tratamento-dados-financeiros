...
- **Protocolo (v1, fechado):** ✅ tipos core = Kit Básico; ✅ dimensionamento (~20–30/tipo) com
  ...
  calibração definido.
- **Máquina do protocolo (`Supabase/migrations/0126_golden_set.sql`, 19/08/2026):** ✅ o protocolo deixou
...
que a motivou não foi este documento, foi a **regra de ouro** do `Arquitetura do Sistema/1 Visão e Doutrina/01`, que `fn_mudar_dial`
...
houver ~20 exemplos, aquele tipo permanece em N0/N1"), e o dial do `Arquitetura do Sistema/2 Especificação/f0/04` é por **estágio**.
