-- Testes do caminho de ESCRITA do golden set (db/migrations/0130).
...
--     … o f0/06 manda AMPLIAR criando rodada nova"). É outra falha, e é o ponto: sem
...
begin
  ...
  -- Um SEGUNDO rotulador no mesmo documento é permitido — é o que o f0/06 pede.
