-- Testes dos TRÊS BOTÕES da pendência (db/migrations/0109).
...
--
--   • os três botões levam aos três estados de `f0/04`, e "contatar o cliente"
...
begin
  ...
  perform teste_assert_dec(v_estado = 'reenviada_ao_cliente', 'no estado de f0/04', v_estado);
  ...
  -- O teto de 3 de f0/04 saiu por decisão do dono. Este assert existe para o dia
  ...
  -- A não-sobrepujável de f0/04 deixou de bloquear quando o humano decide. Com
