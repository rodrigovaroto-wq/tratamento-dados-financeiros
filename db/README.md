...
supabase db execute --file db/migrations/0103_papel_linha_tokeniza_uma_vez.sql
supabase db execute --file db/migrations/0104_desativar_premissa.sql
supabase db execute --file db/migrations/0105_reconciliar_duplicidade_de_rotulo.sql
supabase db execute --file db/migrations/0106_rejeitar_pendencia.sql
